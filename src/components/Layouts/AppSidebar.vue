...
import { Home, Tv2, Calendar, List, Tv2Icon, BookOpen, Library } from '@lucide/vue'
...
const sections = [
  {
    ...
    items: [
      ...
      { label: 'List Manga', to: 'ListManga', icon: Library },
      { label: 'Watch List', to: 'Watchlist', icon: Tv2Icon },
      { label: 'Read List', to: 'Readlist', icon: BookOpen },
    ],
  },
]
